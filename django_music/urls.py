...
urlpatterns = [
    ...
    path('artist/<int:pk>', site_page.single_artist, name='single_artist'),
    path('artist/new/artist', site_page.new_artist, name='new_artist'),
    path('artist/<int:pk>/edit/', site_page.edit_artist, name='edit_artist'),
    path('artist/<int:pk>/delete', site_page.delete_artist, name='delete_artist'),
